# this converts the ECFP from binary strings back into binary vectors 
# It then trains a model to predict the pIC50 trianed on ECFP binary vectors using SupportVectorMachines 
